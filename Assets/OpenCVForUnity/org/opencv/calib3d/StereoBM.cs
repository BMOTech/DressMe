...
//	protected readonly IntPtr nativeObj;
	protected StereoBM(IntPtr addr) { nativeObj = addr; }
...
//	}
	...
	// C++:   StereoBM::StereoBM()
		...
		public static extern IntPtr calib3d_StereoBM_StereoBM_10();
	
	// C++:   StereoBM::StereoBM(int preset, int ndisparities = 0, int SADWindowSize = 21)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr calib3d_StereoBM_StereoBM_11(int preset, int ndisparities, int SADWindowSize);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr calib3d_StereoBM_StereoBM_12(int preset);
	
	// C++:  void StereoBM::operator ()(Mat left, Mat right, Mat& disparity, int disptype = CV_16S)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void calib3d_StereoBM_compute_10(IntPtr nativeObj, IntPtr left_nativeObj, IntPtr right_nativeObj, IntPtr disparity_nativeObj, int disptype);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void calib3d_StereoBM_compute_11(IntPtr nativeObj, IntPtr left_nativeObj, IntPtr right_nativeObj, IntPtr disparity_nativeObj);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void calib3d_StereoBM_delete(IntPtr nativeObj);
