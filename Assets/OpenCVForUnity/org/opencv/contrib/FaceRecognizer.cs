...
//	}
	...
	// C++:  void FaceRecognizer::load(string filename)
		...
		public static extern void contrib_FaceRecognizer_load_10(IntPtr nativeObj, string filename);
	
	// C++:  void FaceRecognizer::predict(Mat src, int& label, double& confidence)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void contrib_FaceRecognizer_predict_10(IntPtr nativeObj, IntPtr src_nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] label_out,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] confidence_out);
	
	// C++:  void FaceRecognizer::save(string filename)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void contrib_FaceRecognizer_save_10(IntPtr nativeObj, string filename);
	
	// C++:  void FaceRecognizer::train(vector_Mat src, Mat labels)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void contrib_FaceRecognizer_train_10(IntPtr nativeObj, IntPtr src_mat_nativeObj, IntPtr labels_nativeObj);
	
	// C++:  void FaceRecognizer::update(vector_Mat src, Mat labels)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void contrib_FaceRecognizer_update_10(IntPtr nativeObj, IntPtr src_mat_nativeObj, IntPtr labels_nativeObj);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void contrib_FaceRecognizer_delete(IntPtr nativeObj);
