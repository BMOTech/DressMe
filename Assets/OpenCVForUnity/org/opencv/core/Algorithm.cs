		...
		return retVal;
				...
				public  string getString (string name)
				{
					ThrowIfDisposed ();
						...
						#if (UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR
			string retVal = core_Algorithm_getString_10(nativeObj, name);
		...
		return retVal;
				...
				public  string paramHelp (string name)
				{
					ThrowIfDisposed ();
						...
						#if (UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR
			string retVal = core_Algorithm_paramHelp_10(nativeObj, name);
...
//	}
	...
	// C++:  bool Algorithm::getBool(string name)
		...
		public static extern bool core_Algorithm_getBool_10(IntPtr nativeObj, string name);
	
	// C++:  double Algorithm::getDouble(string name)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern double core_Algorithm_getDouble_10(IntPtr nativeObj, string name);
	
	// C++:  int Algorithm::getInt(string name)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int core_Algorithm_getInt_10(IntPtr nativeObj, string name);
	
	// C++:  Mat Algorithm::getMat(string name)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr core_Algorithm_getMat_10(IntPtr nativeObj, string name);
	
	// C++:  vector_Mat Algorithm::getMatVector(string name)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr core_Algorithm_getMatVector_10(IntPtr nativeObj, string name);
	
	// C++:  string Algorithm::getString(string name)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern string core_Algorithm_getString_10(IntPtr nativeObj, string name);
	
	// C++:  string Algorithm::paramHelp(string name)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern string core_Algorithm_paramHelp_10(IntPtr nativeObj, string name);
	
	// C++:  int Algorithm::paramType(string name)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int core_Algorithm_paramType_10(IntPtr nativeObj, string name);
	
	// C++:  void Algorithm::setBool(string name, bool value)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void core_Algorithm_setBool_10(IntPtr nativeObj, string name, bool value);
	
	// C++:  void Algorithm::setDouble(string name, double value)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void core_Algorithm_setDouble_10(IntPtr nativeObj, string name, double value);
	
	// C++:  void Algorithm::setInt(string name, int value)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void core_Algorithm_setInt_10(IntPtr nativeObj, string name, int value);
	
	// C++:  void Algorithm::setMat(string name, Mat value)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void core_Algorithm_setMat_10(IntPtr nativeObj, string name, IntPtr value_nativeObj);
	
	// C++:  void Algorithm::setMatVector(string name, vector_Mat value)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void core_Algorithm_setMatVector_10(IntPtr nativeObj, string name, IntPtr value_mat_nativeObj);
	
	// C++:  void Algorithm::setString(string name, string value)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void core_Algorithm_setString_10(IntPtr nativeObj, string name, string value);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void core_Algorithm_delete(IntPtr nativeObj);
