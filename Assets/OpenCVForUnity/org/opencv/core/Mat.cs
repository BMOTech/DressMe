 ...
 */
				...
				{
if (value != null)value.ThrowIfDisposed ();
if (mask != null)mask.ThrowIfDisposed ();
ThrowIfDisposed ();
...
//	
				...
				public string dump ()
				{
					ThrowIfDisposed ();
						...
						#if (UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR
						return core_Mat_nDump (nativeObj);
						#else
						return null;
						#endif
				}
			...
			throw new CvException ("Mat data type is not compatible: " + t);
				...
				public static extern IntPtr core_Mat_n_1Mat__ ();
	
				// C++: Mat::Mat(int rows, int cols, int type)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1Mat__III (int rows, int cols, int type);
	
				// C++: Mat::Mat(Size size, int type)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1Mat__DDI (double size_width, double size_height, int type);
	
				// C++: Mat::Mat(int rows, int cols, int type, Scalar s)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1Mat__IIIDDDD (int rows, int cols, int type, double s_val0, double s_val1, double s_val2, double s_val3);
	
				// C++: Mat::Mat(Size size, int type, Scalar s)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1Mat__DDIDDDD (double size_width, double size_height, int type, double s_val0, double s_val1, double s_val2, double s_val3);
	
				// C++: Mat::Mat(Mat m, Range rowRange, Range colRange = Range::all())
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1Mat__JIIII (IntPtr m_nativeObj, int rowRange_start, int rowRange_end, int colRange_start, int colRange_end);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1Mat__JII (IntPtr m_nativeObj, int rowRange_start, int rowRange_end);
	
				// C++: Mat Mat::adjustROI(int dtop, int dbottom, int dleft, int dright)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1adjustROI (IntPtr nativeObj, int dtop, int dbottom, int dleft, int dright);
	
				// C++: void Mat::assignTo(Mat m, int type = -1)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1assignTo__JJI (IntPtr nativeObj, IntPtr m_nativeObj, int type);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1assignTo__JJ (IntPtr nativeObj, IntPtr m_nativeObj);
	
				// C++: int Mat::channels()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_n_1channels (IntPtr nativeObj);
	
				// C++: int Mat::checkVector(int elemChannels, int depth = -1, bool
				// requireContinuous = true)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_n_1checkVector__JIIZ (IntPtr nativeObj, int elemChannels, int depth, bool requireContinuous);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_n_1checkVector__JII (IntPtr nativeObj, int elemChannels, int depth);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_n_1checkVector__JI (IntPtr nativeObj, int elemChannels);
	
				// C++: Mat Mat::clone()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1clone (IntPtr nativeObj);
	
				// C++: Mat Mat::col(int x)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1col (IntPtr nativeObj, int x);
	
				// C++: Mat Mat::colRange(int startcol, int endcol)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1colRange (IntPtr nativeObj, int startcol, int endcol);
	
				// C++: int Mat::dims()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_n_1dims (IntPtr nativeObj);
	
				// C++: int Mat::cols()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_n_1cols (IntPtr nativeObj);
	
				// C++: void Mat::convertTo(Mat& m, int rtype, double alpha = 1, double beta
				// = 0)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1convertTo__JJIDD (IntPtr nativeObj, IntPtr m_nativeObj, int rtype, double alpha, double beta);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1convertTo__JJID (IntPtr nativeObj, IntPtr m_nativeObj, int rtype, double alpha);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1convertTo__JJI (IntPtr nativeObj, IntPtr m_nativeObj, int rtype);
	
				// C++: void Mat::copyTo(Mat& m)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1copyTo__JJ (IntPtr nativeObj, IntPtr m_nativeObj);
	
				// C++: void Mat::copyTo(Mat& m, Mat mask)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1copyTo__JJJ (IntPtr nativeObj, IntPtr m_nativeObj, IntPtr mask_nativeObj);
	
				// C++: void Mat::create(int rows, int cols, int type)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1create__JIII (IntPtr nativeObj, int rows, int cols, int type);
	
				// C++: void Mat::create(Size size, int type)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1create__JDDI (IntPtr nativeObj, double size_width, double size_height, int type);
	
				// C++: Mat Mat::cross(Mat m)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1cross (IntPtr nativeObj, IntPtr m_nativeObj);
	
				// C++: long Mat::dataAddr()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern long core_Mat_n_1dataAddr (IntPtr nativeObj);
	
				// C++: int Mat::depth()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_n_1depth (IntPtr nativeObj);
	
				// C++: Mat Mat::diag(int d = 0)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1diag__JI (IntPtr nativeObj, int d);
	
				// C++: static Mat Mat::diag(Mat d)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1diag__J (IntPtr d_nativeObj);
	
				// C++: double Mat::dot(Mat m)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern double core_Mat_n_1dot (IntPtr nativeObj, IntPtr m_nativeObj);
	
				// C++: size_t Mat::elemSize()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern long core_Mat_n_1elemSize (IntPtr nativeObj);
	
				// C++: size_t Mat::elemSize1()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern long core_Mat_n_1elemSize1 (IntPtr nativeObj);
	
				// C++: bool Mat::empty()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern bool core_Mat_n_1empty (IntPtr nativeObj);
	
				// C++: static Mat Mat::eye(int rows, int cols, int type)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1eye__III (int rows, int cols, int type);
	
				// C++: static Mat Mat::eye(Size size, int type)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1eye__DDI (double size_width, double size_height, int type);
	
				// C++: Mat Mat::inv(int method = DECOMP_LU)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1inv__JI (IntPtr nativeObj, int method);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1inv__J (IntPtr nativeObj);
	
				// C++: bool Mat::isContinuous()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern bool core_Mat_n_1isContinuous (IntPtr nativeObj);
	
				// C++: bool Mat::isSubmatrix()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern bool core_Mat_n_1isSubmatrix (IntPtr nativeObj);
	
				// C++: void Mat::locateROI(Size wholeSize, Point ofs)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_locateROI_10 (IntPtr nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] wholeSize_out, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] ofs_out);
	
				// C++: Mat Mat::mul(Mat m, double scale = 1)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1mul__JJD (IntPtr nativeObj, IntPtr m_nativeObj, double scale);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1mul__JJ (IntPtr nativeObj, IntPtr m_nativeObj);
	
				// C++: static Mat Mat::ones(int rows, int cols, int type)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1ones__III (int rows, int cols, int type);
	
				// C++: static Mat Mat::ones(Size size, int type)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1ones__DDI (double size_width, double size_height, int type);
	
				// C++: void Mat::push_back(Mat m)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1push_1back (IntPtr nativeObj, IntPtr m_nativeObj);
	
				// C++: void Mat::release()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1release (IntPtr nativeObj);
	
				// C++: Mat Mat::reshape(int cn, int rows = 0)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1reshape__JII (IntPtr nativeObj, int cn, int rows);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1reshape__JI (IntPtr nativeObj, int cn);
	
				// C++: Mat Mat::row(int y)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1row (IntPtr nativeObj, int y);
	
				// C++: Mat Mat::rowRange(int startrow, int endrow)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1rowRange (IntPtr nativeObj, int startrow, int endrow);
	
				// C++: int Mat::rows()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_n_1rows (IntPtr nativeObj);
	
				// C++: Mat Mat::operator =(Scalar s)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1setTo__JDDDD (IntPtr nativeObj, double s_val0, double s_val1, double s_val2, double s_val3);
	
				// C++: Mat Mat::setTo(Scalar value, Mat mask = Mat())
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1setTo__JDDDDJ (IntPtr nativeObj, double s_val0, double s_val1, double s_val2, double s_val3, IntPtr mask_nativeObj);
	
				// C++: Mat Mat::setTo(Mat value, Mat mask = Mat())
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1setTo__JJJ (IntPtr nativeObj, IntPtr value_nativeObj, IntPtr mask_nativeObj);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1setTo__JJ (IntPtr nativeObj, IntPtr value_nativeObj);
	
				// C++: Size Mat::size()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1size (IntPtr nativeObj,
		                                                  [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);

	
				// C++: size_t Mat::step1(int i = 0)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern long core_Mat_n_1step1__JI (IntPtr nativeObj, int i);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern long core_Mat_n_1step1__J (IntPtr nativeObj);
	
				// C++: Mat Mat::operator()(Range rowRange, Range colRange)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1submat_1rr (IntPtr nativeObj, int rowRange_start, int rowRange_end, int colRange_start, int colRange_end);
	
				// C++: Mat Mat::operator()(Rect roi)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1submat (IntPtr nativeObj, int roi_x, int roi_y, int roi_width, int roi_height);
	
				// C++: Mat Mat::t()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1t (IntPtr nativeObj);
	
				// C++: size_t Mat::total()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern long core_Mat_n_1total (IntPtr nativeObj);
	
				// C++: int Mat::type()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_n_1type (IntPtr nativeObj);
	
				// C++: static Mat Mat::zeros(int rows, int cols, int type)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1zeros__III (int rows, int cols, int type);
	
				// C++: static Mat Mat::zeros(Size size, int type)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr core_Mat_n_1zeros__DDI (double size_width, double size_height, int type);
	
				// native support for java finalize()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void core_Mat_n_1delete (IntPtr nativeObj);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_nPutD (IntPtr self, int row, int col, int count, [In, MarshalAs(UnmanagedType.LPArray)] double[] data);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_nPutF (IntPtr self, int row, int col, int count, [In, MarshalAs(UnmanagedType.LPArray)] float[] data);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_nPutI (IntPtr self, int row, int col, int count, [In, MarshalAs(UnmanagedType.LPArray)] int[] data);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_nPutS (IntPtr self, int row, int col, int count, [In, MarshalAs(UnmanagedType.LPArray)] short[] data);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_nPutB (IntPtr self, int row, int col, int count, [In, MarshalAs(UnmanagedType.LPArray)] byte[] data);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_nGetB (IntPtr self, int row, int col, int count, [In, Out, MarshalAs(UnmanagedType.LPArray)] byte[] vals);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_nGetS (IntPtr self, int row, int col, int count, [In, Out, MarshalAs(UnmanagedType.LPArray)] short[] vals);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_nGetI (IntPtr self, int row, int col, int count, [In, Out, MarshalAs(UnmanagedType.LPArray)] int[] vals);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_nGetF (IntPtr self, int row, int col, int count, [In, Out, MarshalAs(UnmanagedType.LPArray)] float[] vals);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_nGetD (IntPtr self, int row, int col, int count, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int core_Mat_nGet (IntPtr self, int row, int col, int count, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
	
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern string core_Mat_nDump (IntPtr self);
