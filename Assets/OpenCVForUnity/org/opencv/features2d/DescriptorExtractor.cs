...
//	}
	...
	// C++:  void javaDescriptorExtractor::compute(Mat image, vector_KeyPoint& keypoints, Mat descriptors)
		...
		public static extern void features2d_DescriptorExtractor_compute_10(IntPtr nativeObj, IntPtr image_nativeObj, IntPtr keypoints_mat_nativeObj, IntPtr descriptors_nativeObj);
	
	// C++:  void javaDescriptorExtractor::compute(vector_Mat images, vector_vector_KeyPoint& keypoints, vector_Mat& descriptors)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void features2d_DescriptorExtractor_compute_11(IntPtr nativeObj, IntPtr images_mat_nativeObj, IntPtr keypoints_mat_nativeObj, IntPtr descriptors_mat_nativeObj);
	
	// C++: static javaDescriptorExtractor* javaDescriptorExtractor::create(int extractorType)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr features2d_DescriptorExtractor_create_10(int extractorType);
	
	// C++:  int javaDescriptorExtractor::descriptorSize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int features2d_DescriptorExtractor_descriptorSize_10(IntPtr nativeObj);
	
	// C++:  int javaDescriptorExtractor::descriptorType()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int features2d_DescriptorExtractor_descriptorType_10(IntPtr nativeObj);
	
	// C++:  bool javaDescriptorExtractor::empty()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool features2d_DescriptorExtractor_empty_10(IntPtr nativeObj);
	
	// C++:  void javaDescriptorExtractor::read(string fileName)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void features2d_DescriptorExtractor_read_10(IntPtr nativeObj, string fileName);
	
	// C++:  void javaDescriptorExtractor::write(string fileName)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void features2d_DescriptorExtractor_write_10(IntPtr nativeObj, string fileName);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void features2d_DescriptorExtractor_delete(IntPtr nativeObj);
