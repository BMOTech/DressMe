		...
		return retVal;
				...
				public  string name ()
				{
					ThrowIfDisposed ();
						...
						#if (UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR
			string retVal = gpu_DeviceInfo_name_10(nativeObj);
...
//	}
	...
	// C++:   DeviceInfo::DeviceInfo()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr gpu_DeviceInfo_DeviceInfo_10();
	
	// C++:   DeviceInfo::DeviceInfo(int device_id)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr gpu_DeviceInfo_DeviceInfo_11(int device_id);
	
	// C++:  int DeviceInfo::deviceID()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int gpu_DeviceInfo_deviceID_10(IntPtr nativeObj);
	
	// C++:  size_t DeviceInfo::freeMemory()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern long gpu_DeviceInfo_freeMemory_10(IntPtr nativeObj);
	
	// C++:  bool DeviceInfo::isCompatible()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern bool gpu_DeviceInfo_isCompatible_10(IntPtr nativeObj);
	
	// C++:  int DeviceInfo::majorVersion()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int gpu_DeviceInfo_majorVersion_10(IntPtr nativeObj);
	
	// C++:  int DeviceInfo::minorVersion()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int gpu_DeviceInfo_minorVersion_10(IntPtr nativeObj);
	
	// C++:  int DeviceInfo::multiProcessorCount()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int gpu_DeviceInfo_multiProcessorCount_10(IntPtr nativeObj);
	
	// C++:  string DeviceInfo::name()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern string gpu_DeviceInfo_name_10(IntPtr nativeObj);
	
	// C++:  void DeviceInfo::queryMemory(size_t& totalMemory, size_t& freeMemory)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void gpu_DeviceInfo_queryMemory_10(IntPtr nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] totalMemory_out,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] freeMemory_out);
	
	// C++:  size_t DeviceInfo::sharedMemPerBlock()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern long gpu_DeviceInfo_sharedMemPerBlock_10(IntPtr nativeObj);
	
	// C++:  bool DeviceInfo::supports(int feature_set)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern bool gpu_DeviceInfo_supports_10(IntPtr nativeObj, int feature_set);
	
	// C++:  size_t DeviceInfo::totalMemory()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern long gpu_DeviceInfo_totalMemory_10(IntPtr nativeObj);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void gpu_DeviceInfo_delete(IntPtr nativeObj);
