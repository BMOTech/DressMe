...
namespace OpenCVForUnity
{
	...
	[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool gpu_Gpu_deviceSupports_10(int feature_set);
	
	// C++:  int getCudaEnabledDeviceCount()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int gpu_Gpu_getCudaEnabledDeviceCount_10();
	
	// C++:  int getDevice()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int gpu_Gpu_getDevice_10();
	
	// C++:  void printCudaDeviceInfo(int device)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void gpu_Gpu_printCudaDeviceInfo_10(int device);
	
	// C++:  void printShortCudaDeviceInfo(int device)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void gpu_Gpu_printShortCudaDeviceInfo_10(int device);
	
	// C++:  void resetDevice()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void gpu_Gpu_resetDevice_10();
	
	// C++:  void setDevice(int device)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void gpu_Gpu_setDevice_10(int device);
