...
//	}
	...
	// C++: static bool TargetArchs::builtWith(int feature_set)
		...
		public static extern bool gpu_TargetArchs_builtWith_10(int feature_set);
	
	// C++: static bool TargetArchs::has(int major, int minor)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool gpu_TargetArchs_has_10(int major, int minor);
	
	// C++: static bool TargetArchs::hasBin(int major, int minor)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool gpu_TargetArchs_hasBin_10(int major, int minor);
	
	// C++: static bool TargetArchs::hasEqualOrGreater(int major, int minor)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool gpu_TargetArchs_hasEqualOrGreater_10(int major, int minor);
	
	// C++: static bool TargetArchs::hasEqualOrGreaterBin(int major, int minor)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool gpu_TargetArchs_hasEqualOrGreaterBin_10(int major, int minor);
	
	// C++: static bool TargetArchs::hasEqualOrGreaterPtx(int major, int minor)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool gpu_TargetArchs_hasEqualOrGreaterPtx_10(int major, int minor);
	
	// C++: static bool TargetArchs::hasEqualOrLessPtx(int major, int minor)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool gpu_TargetArchs_hasEqualOrLessPtx_10(int major, int minor);
	
	// C++: static bool TargetArchs::hasPtx(int major, int minor)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool gpu_TargetArchs_hasPtx_10(int major, int minor);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void gpu_TargetArchs_delete(IntPtr nativeObj);
