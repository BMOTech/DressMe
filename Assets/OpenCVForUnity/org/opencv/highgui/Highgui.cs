...
if (img != null)img.ThrowIfDisposed ();
	...
	// C++:  Mat imdecode(Mat buf, int flags)
		...
		public static extern IntPtr highgui_Highgui_imdecode_10(IntPtr buf_nativeObj, int flags);
	
	// C++:  bool imencode(string ext, Mat img, vector_uchar& buf, vector_int params = vector<int>())
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool highgui_Highgui_imencode_10(string ext, IntPtr img_nativeObj, IntPtr buf_mat_nativeObj, IntPtr params_mat_nativeObj);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool highgui_Highgui_imencode_11(string ext, IntPtr img_nativeObj, IntPtr buf_mat_nativeObj);
	
	// C++:  Mat imread(string filename, int flags = 1)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr highgui_Highgui_imread_10(string filename, int flags);

		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr highgui_Highgui_imread_11(string filename);
	
	// C++:  bool imwrite(string filename, Mat img, vector_int params = vector<int>())
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool highgui_Highgui_imwrite_10(string filename, IntPtr img_nativeObj, IntPtr params_mat_nativeObj);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool highgui_Highgui_imwrite_11(string filename, IntPtr img_nativeObj);
