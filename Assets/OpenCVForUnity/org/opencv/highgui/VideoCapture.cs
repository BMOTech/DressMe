		...
		return retVal;
				...
				public List<Size> getSupportedPreviewSizes ()
				{
					ThrowIfDisposed ();
						...
						#if (UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR
			string[] sizes_str = highgui_VideoCapture_n_1getSupportedPreviewSizes(nativeObj).Split(',');//TODO:@check
...
//	}
	...
	// C++: VideoCapture::VideoCapture()
		...
		public static extern IntPtr highgui_VideoCapture_n_1VideoCapture__();
	
//	// C++: VideoCapture::VideoCapture(string filename)
//	[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
//		public static extern IntPtr n_VideoCapture(string filename);
	
	// C++: VideoCapture::VideoCapture(int device)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr highgui_VideoCapture_n_1VideoCapture__I(int device);
	
	// C++: double VideoCapture::get(int propId)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern double highgui_VideoCapture_n_1get(IntPtr nativeObj, int propId);
	
	// C++: bool VideoCapture::grab()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool highgui_VideoCapture_n_1grab(IntPtr nativeObj);
	
	// C++: bool VideoCapture::isOpened()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool highgui_VideoCapture_n_1isOpened(IntPtr nativeObj);
	
//	// C++: bool VideoCapture::open(string filename)
//		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
//		public static extern bool n_open(IntPtr nativeObj, string filename);
	
	// C++: bool VideoCapture::open(int device)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool highgui_VideoCapture_n_1open__JI(IntPtr nativeObj, int device);
	
	// C++: bool VideoCapture::read(Mat image)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool highgui_VideoCapture_n_1read(IntPtr nativeObj, IntPtr image_nativeObj);
	
	// C++: void VideoCapture::release()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void highgui_VideoCapture_n_1release(IntPtr nativeObj);
	
	// C++: bool VideoCapture::retrieve(Mat image, int channel = 0)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool highgui_VideoCapture_n_1retrieve__JJI(IntPtr nativeObj, IntPtr image_nativeObj, int channel);
	
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool highgui_VideoCapture_n_1retrieve__JJ(IntPtr nativeObj, IntPtr image_nativeObj);
	
	// C++: bool VideoCapture::set(int propId, double value)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern bool highgui_VideoCapture_n_1set(IntPtr nativeObj, int propId, double value);
	
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern string highgui_VideoCapture_n_1getSupportedPreviewSizes(IntPtr nativeObj);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void highgui_VideoCapture_n_1delete(IntPtr nativeObj);
