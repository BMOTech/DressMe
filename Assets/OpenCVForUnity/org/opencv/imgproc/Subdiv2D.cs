...
//	}
	...
	// C++:   Subdiv2D::Subdiv2D()
		...
		public static extern IntPtr imgproc_Subdiv2D_Subdiv2D_10();
	
	// C++:   Subdiv2D::Subdiv2D(Rect rect)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr imgproc_Subdiv2D_Subdiv2D_11(int rect_x, int rect_y, int rect_width, int rect_height);
	
	// C++:  int Subdiv2D::edgeDst(int edge, Point2f* dstpt = 0)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int imgproc_Subdiv2D_edgeDst_10(IntPtr nativeObj, int edge, double[] dstpt_out);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int imgproc_Subdiv2D_edgeDst_11(IntPtr nativeObj, int edge);
	
	// C++:  int Subdiv2D::edgeOrg(int edge, Point2f* orgpt = 0)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int imgproc_Subdiv2D_edgeOrg_10(IntPtr nativeObj, int edge, double[] orgpt_out);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int imgproc_Subdiv2D_edgeOrg_11(IntPtr nativeObj, int edge);
	
	// C++:  int Subdiv2D::findNearest(Point2f pt, Point2f* nearestPt = 0)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int imgproc_Subdiv2D_findNearest_10(IntPtr nativeObj, double pt_x, double pt_y, double[] nearestPt_out);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int imgproc_Subdiv2D_findNearest_11(IntPtr nativeObj, double pt_x, double pt_y);
	
	// C++:  int Subdiv2D::getEdge(int edge, int nextEdgeType)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int imgproc_Subdiv2D_getEdge_10(IntPtr nativeObj, int edge, int nextEdgeType);
	
	// C++:  void Subdiv2D::getEdgeList(vector_Vec4f& edgeList)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void imgproc_Subdiv2D_getEdgeList_10(IntPtr nativeObj, IntPtr edgeList_mat_nativeObj);
	
	// C++:  void Subdiv2D::getTriangleList(vector_Vec6f& triangleList)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void imgproc_Subdiv2D_getTriangleList_10(IntPtr nativeObj, IntPtr triangleList_mat_nativeObj);
	
	// C++:  Point2f Subdiv2D::getVertex(int vertex, int* firstEdge = 0)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void imgproc_Subdiv2D_getVertex_10(IntPtr nativeObj, int vertex, double[] firstEdge_out,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void imgproc_Subdiv2D_getVertex_11(IntPtr nativeObj, int vertex,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
	
	// C++:  void Subdiv2D::getVoronoiFacetList(vector_int idx, vector_vector_Point2f& facetList, vector_Point2f& facetCenters)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void imgproc_Subdiv2D_getVoronoiFacetList_10(IntPtr nativeObj, IntPtr idx_mat_nativeObj, IntPtr facetList_mat_nativeObj, IntPtr facetCenters_mat_nativeObj);
	
	// C++:  void Subdiv2D::initDelaunay(Rect rect)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void imgproc_Subdiv2D_initDelaunay_10(IntPtr nativeObj, int rect_x, int rect_y, int rect_width, int rect_height);
	
	// C++:  int Subdiv2D::insert(Point2f pt)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int imgproc_Subdiv2D_insert_10(IntPtr nativeObj, double pt_x, double pt_y);
	
	// C++:  void Subdiv2D::insert(vector_Point2f ptvec)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void imgproc_Subdiv2D_insert_11(IntPtr nativeObj, IntPtr ptvec_mat_nativeObj);
	
	// C++:  int Subdiv2D::locate(Point2f pt, int& edge, int& vertex)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int imgproc_Subdiv2D_locate_10(IntPtr nativeObj, double pt_x, double pt_y, double[] edge_out, double[] vertex_out);
	
	// C++:  int Subdiv2D::nextEdge(int edge)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int imgproc_Subdiv2D_nextEdge_10(IntPtr nativeObj, int edge);
	
	// C++:  int Subdiv2D::rotateEdge(int edge, int rotate)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int imgproc_Subdiv2D_rotateEdge_10(IntPtr nativeObj, int edge, int rotate);
	
	// C++:  int Subdiv2D::symEdge(int edge)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern int imgproc_Subdiv2D_symEdge_10(IntPtr nativeObj, int edge);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
		public static extern void imgproc_Subdiv2D_delete(IntPtr nativeObj);
