...
//	}
	...
	// C++:   CvANN_MLP::CvANN_MLP()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr ml_CvANN_1MLP_CvANN_1MLP_10();
	
	// C++:   CvANN_MLP::CvANN_MLP(Mat layerSizes, int activateFunc = CvANN_MLP::SIGMOID_SYM, double fparam1 = 0, double fparam2 = 0)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr ml_CvANN_1MLP_CvANN_1MLP_11(IntPtr layerSizes_nativeObj, int activateFunc, double fparam1, double fparam2);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr ml_CvANN_1MLP_CvANN_1MLP_12(IntPtr layerSizes_nativeObj);
	
	// C++:  void CvANN_MLP::clear()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvANN_1MLP_clear_10(IntPtr nativeObj);
	
	// C++:  void CvANN_MLP::create(Mat layerSizes, int activateFunc = CvANN_MLP::SIGMOID_SYM, double fparam1 = 0, double fparam2 = 0)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvANN_1MLP_create_10(IntPtr nativeObj, IntPtr layerSizes_nativeObj, int activateFunc, double fparam1, double fparam2);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvANN_1MLP_create_11(IntPtr nativeObj, IntPtr layerSizes_nativeObj);
	
	// C++:  float CvANN_MLP::predict(Mat inputs, Mat& outputs)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern float ml_CvANN_1MLP_predict_10(IntPtr nativeObj, IntPtr inputs_nativeObj, IntPtr outputs_nativeObj);
	
	// C++:  int CvANN_MLP::train(Mat inputs, Mat outputs, Mat sampleWeights, Mat sampleIdx = cv::Mat(), CvANN_MLP_TrainParams params = CvANN_MLP_TrainParams(), int flags = 0)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int ml_CvANN_1MLP_train_10(IntPtr nativeObj, IntPtr inputs_nativeObj, IntPtr outputs_nativeObj, IntPtr sampleWeights_nativeObj, IntPtr sampleIdx_nativeObj, IntPtr params_nativeObj, int flags);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int ml_CvANN_1MLP_train_11(IntPtr nativeObj, IntPtr inputs_nativeObj, IntPtr outputs_nativeObj, IntPtr sampleWeights_nativeObj);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvANN_1MLP_delete(IntPtr nativeObj);
