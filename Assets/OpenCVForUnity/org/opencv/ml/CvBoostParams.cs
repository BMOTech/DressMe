...
//	}
	...
	// C++:   CvBoostParams::CvBoostParams()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr ml_CvBoostParams_CvBoostParams_10();
	
	// C++: int CvBoostParams::boost_type
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int ml_CvBoostParams_get_1boost_1type_10(IntPtr nativeObj);
	
	// C++: void CvBoostParams::boost_type
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvBoostParams_set_1boost_1type_10(IntPtr nativeObj, int boost_type);
	
	// C++: int CvBoostParams::weak_count
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int ml_CvBoostParams_get_1weak_1count_10(IntPtr nativeObj);
	
	// C++: void CvBoostParams::weak_count
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvBoostParams_set_1weak_1count_10(IntPtr nativeObj, int weak_count);
	
	// C++: int CvBoostParams::split_criteria
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int ml_CvBoostParams_get_1split_1criteria_10(IntPtr nativeObj);
	
	// C++: void CvBoostParams::split_criteria
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvBoostParams_set_1split_1criteria_10(IntPtr nativeObj, int split_criteria);
	
	// C++: double CvBoostParams::weight_trim_rate
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern double ml_CvBoostParams_get_1weight_1trim_1rate_10(IntPtr nativeObj);
	
	// C++: void CvBoostParams::weight_trim_rate
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvBoostParams_set_1weight_1trim_1rate_10(IntPtr nativeObj, double weight_trim_rate);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvBoostParams_delete(IntPtr nativeObj);
