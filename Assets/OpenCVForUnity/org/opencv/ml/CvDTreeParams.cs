...
//	}
	...
	// C++:   CvDTreeParams::CvDTreeParams()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr ml_CvDTreeParams_CvDTreeParams_10();
	
	// C++: int CvDTreeParams::max_categories
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int ml_CvDTreeParams_get_1max_1categories_10(IntPtr nativeObj);
	
	// C++: void CvDTreeParams::max_categories
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvDTreeParams_set_1max_1categories_10(IntPtr nativeObj, int max_categories);
	
	// C++: int CvDTreeParams::max_depth
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int ml_CvDTreeParams_get_1max_1depth_10(IntPtr nativeObj);
	
	// C++: void CvDTreeParams::max_depth
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvDTreeParams_set_1max_1depth_10(IntPtr nativeObj, int max_depth);
	
	// C++: int CvDTreeParams::min_sample_count
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int ml_CvDTreeParams_get_1min_1sample_1count_10(IntPtr nativeObj);
	
	// C++: void CvDTreeParams::min_sample_count
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvDTreeParams_set_1min_1sample_1count_10(IntPtr nativeObj, int min_sample_count);
	
	// C++: int CvDTreeParams::cv_folds
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int ml_CvDTreeParams_get_1cv_1folds_10(IntPtr nativeObj);
	
	// C++: void CvDTreeParams::cv_folds
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvDTreeParams_set_1cv_1folds_10(IntPtr nativeObj, int cv_folds);
	
	// C++: bool CvDTreeParams::use_surrogates
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern bool ml_CvDTreeParams_get_1use_1surrogates_10(IntPtr nativeObj);
	
	// C++: void CvDTreeParams::use_surrogates
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvDTreeParams_set_1use_1surrogates_10(IntPtr nativeObj, bool use_surrogates);
	
	// C++: bool CvDTreeParams::use_1se_rule
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern bool ml_CvDTreeParams_get_1use_11se_1rule_10(IntPtr nativeObj);
	
	// C++: void CvDTreeParams::use_1se_rule
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvDTreeParams_set_1use_11se_1rule_10(IntPtr nativeObj, bool use_1se_rule);
	
	// C++: bool CvDTreeParams::truncate_pruned_tree
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern bool ml_CvDTreeParams_get_1truncate_1pruned_1tree_10(IntPtr nativeObj);
	
	// C++: void CvDTreeParams::truncate_pruned_tree
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvDTreeParams_set_1truncate_1pruned_1tree_10(IntPtr nativeObj, bool truncate_pruned_tree);
	
	// C++: float CvDTreeParams::regression_accuracy
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern float ml_CvDTreeParams_get_1regression_1accuracy_10(IntPtr nativeObj);
	
	// C++: void CvDTreeParams::regression_accuracy
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvDTreeParams_set_1regression_1accuracy_10(IntPtr nativeObj, float regression_accuracy);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvDTreeParams_delete(IntPtr nativeObj);
