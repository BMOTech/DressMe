...
//	}
	...
	// C++:   CvGBTreesParams::CvGBTreesParams()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr ml_CvGBTreesParams_CvGBTreesParams_10();
	
	// C++: int CvGBTreesParams::weak_count
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int ml_CvGBTreesParams_get_1weak_1count_10(IntPtr nativeObj);
	
	// C++: void CvGBTreesParams::weak_count
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvGBTreesParams_set_1weak_1count_10(IntPtr nativeObj, int weak_count);
	
	// C++: int CvGBTreesParams::loss_function_type
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int ml_CvGBTreesParams_get_1loss_1function_1type_10(IntPtr nativeObj);
	
	// C++: void CvGBTreesParams::loss_function_type
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvGBTreesParams_set_1loss_1function_1type_10(IntPtr nativeObj, int loss_function_type);
	
	// C++: float CvGBTreesParams::subsample_portion
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern float ml_CvGBTreesParams_get_1subsample_1portion_10(IntPtr nativeObj);
	
	// C++: void CvGBTreesParams::subsample_portion
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvGBTreesParams_set_1subsample_1portion_10(IntPtr nativeObj, float subsample_portion);
	
	// C++: float CvGBTreesParams::shrinkage
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern float ml_CvGBTreesParams_get_1shrinkage_10(IntPtr nativeObj);
	
	// C++: void CvGBTreesParams::shrinkage
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvGBTreesParams_set_1shrinkage_10(IntPtr nativeObj, float shrinkage);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvGBTreesParams_delete(IntPtr nativeObj);
