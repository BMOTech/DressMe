...
//	}
	...
	// C++:   CvNormalBayesClassifier::CvNormalBayesClassifier()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr ml_CvNormalBayesClassifier_CvNormalBayesClassifier_10();
	
	// C++:   CvNormalBayesClassifier::CvNormalBayesClassifier(Mat trainData, Mat responses, Mat varIdx = cv::Mat(), Mat sampleIdx = cv::Mat())
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr ml_CvNormalBayesClassifier_CvNormalBayesClassifier_11(IntPtr trainData_nativeObj, IntPtr responses_nativeObj, IntPtr varIdx_nativeObj, IntPtr sampleIdx_nativeObj);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr ml_CvNormalBayesClassifier_CvNormalBayesClassifier_12(IntPtr trainData_nativeObj, IntPtr responses_nativeObj);
	
	// C++:  void CvNormalBayesClassifier::clear()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvNormalBayesClassifier_clear_10(IntPtr nativeObj);
	
	// C++:  float CvNormalBayesClassifier::predict(Mat samples, Mat* results = 0)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern float ml_CvNormalBayesClassifier_predict_10(IntPtr nativeObj, IntPtr samples_nativeObj, IntPtr results_nativeObj);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern float ml_CvNormalBayesClassifier_predict_11(IntPtr nativeObj, IntPtr samples_nativeObj);
	
	// C++:  bool CvNormalBayesClassifier::train(Mat trainData, Mat responses, Mat varIdx = cv::Mat(), Mat sampleIdx = cv::Mat(), bool update = false)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern bool ml_CvNormalBayesClassifier_train_10(IntPtr nativeObj, IntPtr trainData_nativeObj, IntPtr responses_nativeObj, IntPtr varIdx_nativeObj, IntPtr sampleIdx_nativeObj, bool update);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern bool ml_CvNormalBayesClassifier_train_11(IntPtr nativeObj, IntPtr trainData_nativeObj, IntPtr responses_nativeObj);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvNormalBayesClassifier_delete(IntPtr nativeObj);
