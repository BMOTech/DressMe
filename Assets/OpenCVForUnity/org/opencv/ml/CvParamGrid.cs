...
//	}
	...
	// C++:   CvParamGrid::CvParamGrid()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr ml_CvParamGrid_CvParamGrid_10();
	
	// C++: double CvParamGrid::min_val
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern double ml_CvParamGrid_get_1min_1val_10(IntPtr nativeObj);
	
	// C++: void CvParamGrid::min_val
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvParamGrid_set_1min_1val_10(IntPtr nativeObj, double min_val);
	
	// C++: double CvParamGrid::max_val
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern double ml_CvParamGrid_get_1max_1val_10(IntPtr nativeObj);
	
	// C++: void CvParamGrid::max_val
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvParamGrid_set_1max_1val_10(IntPtr nativeObj, double max_val);
	
	// C++: double CvParamGrid::step
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern double ml_CvParamGrid_get_1step_10(IntPtr nativeObj);
	
	// C++: void CvParamGrid::step
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvParamGrid_set_1step_10(IntPtr nativeObj, double step);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvParamGrid_delete(IntPtr nativeObj);
