...
//	}
	...
	// C++:   CvRTParams::CvRTParams()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr ml_CvRTParams_CvRTParams_10();
	
	// C++: bool CvRTParams::calc_var_importance
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern bool ml_CvRTParams_get_1calc_1var_1importance_10(IntPtr nativeObj);
	
	// C++: void CvRTParams::calc_var_importance
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvRTParams_set_1calc_1var_1importance_10(IntPtr nativeObj, bool calc_var_importance);
	
	// C++: int CvRTParams::nactive_vars
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern int ml_CvRTParams_get_1nactive_1vars_10(IntPtr nativeObj);
	
	// C++: void CvRTParams::nactive_vars
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvRTParams_set_1nactive_1vars_10(IntPtr nativeObj, int nactive_vars);
	
	// C++: TermCriteria CvRTParams::term_crit
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern double[] ml_CvRTParams_get_1term_1crit_10(IntPtr nativeObj);
	
	// C++: void CvRTParams::term_crit
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvRTParams_set_1term_1crit_10(IntPtr nativeObj, int term_crit_type, int term_crit_maxCount, double term_crit_epsilon);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void ml_CvRTParams_delete(IntPtr nativeObj);
