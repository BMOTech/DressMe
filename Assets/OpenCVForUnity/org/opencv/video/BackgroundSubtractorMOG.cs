...
//	}
	...
	// C++:   BackgroundSubtractorMOG::BackgroundSubtractorMOG()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr video_BackgroundSubtractorMOG_BackgroundSubtractorMOG_10();
	
	// C++:   BackgroundSubtractorMOG::BackgroundSubtractorMOG(int history, int nmixtures, double backgroundRatio, double noiseSigma = 0)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr video_BackgroundSubtractorMOG_BackgroundSubtractorMOG_11(int history, int nmixtures, double backgroundRatio, double noiseSigma);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr video_BackgroundSubtractorMOG_BackgroundSubtractorMOG_12(int history, int nmixtures, double backgroundRatio);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void video_BackgroundSubtractorMOG_delete(IntPtr nativeObj);
