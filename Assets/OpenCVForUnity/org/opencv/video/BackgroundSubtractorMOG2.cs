...
//	}
				...
				public static extern IntPtr video_BackgroundSubtractorMOG2_BackgroundSubtractorMOG2_10 ();
	
				// C++:   BackgroundSubtractorMOG2::BackgroundSubtractorMOG2(int history, float varThreshold, bool bShadowDetection = true)
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr video_BackgroundSubtractorMOG2_BackgroundSubtractorMOG2_11 (int history, float varThreshold, bool bShadowDetection);

				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr video_BackgroundSubtractorMOG2_BackgroundSubtractorMOG2_12 (int history, float varThreshold);
	
				// native support for java finalize()
				[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void video_BackgroundSubtractorMOG2_delete (IntPtr nativeObj);
