...
//	}
	...
	// C++:   KalmanFilter::KalmanFilter()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr video_KalmanFilter_KalmanFilter_10();
	
	// C++:   KalmanFilter::KalmanFilter(int dynamParams, int measureParams, int controlParams = 0, int type = CV_32F)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr video_KalmanFilter_KalmanFilter_11(int dynamParams, int measureParams, int controlParams, int type);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr video_KalmanFilter_KalmanFilter_12(int dynamParams, int measureParams);
	
	// C++:  Mat KalmanFilter::correct(Mat measurement)
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr video_KalmanFilter_correct_10(IntPtr nativeObj, IntPtr measurement_nativeObj);
	
	// C++:  Mat KalmanFilter::predict(Mat control = Mat())
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr video_KalmanFilter_predict_10(IntPtr nativeObj, IntPtr control_nativeObj);
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern IntPtr video_KalmanFilter_predict_11(IntPtr nativeObj);
	
	// native support for java finalize()
		[DllImport("opencvforunity", CallingConvention = CallingConvention.Cdecl)]
				public static extern void video_KalmanFilter_delete(IntPtr nativeObj);
